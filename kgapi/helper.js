 ...
 *
 * @module helper
 * @requires https://cdmsc.chen-jin.dpdns.org/kgapi/crypto - MD5 加密函数
 * @requires https://cdmsc.chen-jin.dpdns.org/kgapi/config.json - 平台配置（appid、clientver 等）
 */

await import('https://cdmsc.chen-jin.dpdns.org/kgapi/crypto-js.js');
import { cryptoMd5, wordArrayFromBuffer } from 'https://cdmsc.chen-jin.dpdns.org/kgapi/crypto.js';
const { appid: useAppid, liteAppid, clientver: useClientver, liteClientver } = {
